import slidingWindow.fruitInBasket

fun main(args: Array<String>) {
//    println(slidingWindow.maxSumOfSubArrays(intArrayOf(2, 3, 4, 1, 5), 2))
//    println(slidingWindow.smallestSubArrayGivenSum(intArrayOf(3, 4, 1, 1, 6), 8))
//    println(slidingWindow.longestSubstringWithDistinctCharacters("araaci", 2))
